We love that you’re interested in contributing to SocialTextView! Any contribution is more than welcome!

## SocialTextView is simple
...
```bash
open SocialTextView.xcodeproj
```

## Pass Tests

In order to archive best quality, SocialTextView has a lot tests to pursue this goal. After changed the code, it's better to update the tests accordingly and have all tests passed with the following command:
